...
import aster.welkin.registry.world.WelkinDimensions;
...
public class WelkinNoiseSettings {
    ...
    public static void bootstrap(Registerable<ChunkGeneratorSettings> context) {
        ...
        context.register(WelkinDimensions.ROLLING_HILLS, settings, Lifecycle.stable());
    }
}
