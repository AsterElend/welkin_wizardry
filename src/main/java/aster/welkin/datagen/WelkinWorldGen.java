...
public class WelkinWorldGen extends FabricDynamicRegistryProvider {


    public WelkinWorldGen(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registriesFuture) {
