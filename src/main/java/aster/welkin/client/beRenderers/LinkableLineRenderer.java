...
public class LinkableLineRenderer<T extends BlockEntity> implements BlockEntityRenderer<T> {
    public LinkableLineRenderer(BlockEntityRendererFactory.Context ctx) {
