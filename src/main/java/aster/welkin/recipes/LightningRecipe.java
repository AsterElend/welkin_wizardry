...
public class LightningRecipe implements Recipe<SimpleInventory> {
    ...
    public static class LightningSerializer implements RecipeSerializer<LightningRecipe>{
        @Override
        public LightningRecipe read(Identifier id, JsonObject json) {
            ...
            return new LightningRecipe(id, ingredient, new ItemStack(resultItem, count));
        }
        ...
        public LightningRecipe read(Identifier id, PacketByteBuf buf) {
            ...
            return new LightningRecipe(id, ingredient, result);
        }
