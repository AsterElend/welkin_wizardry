...
public abstract class FalseMilkFluid extends FlowableFluid {
    public FalseMilkFluid() {
    }


    public Fluid getFlowing() {
        return WelkinFluids.FALSE_MILK_FLOWING;
    }

    public Fluid getStill() {
        return WelkinFluids.FALSE_MILK_STATIC;
    }

    public Item getBucketItem() {
        return WelkinItems.FALSE_MILK_BUCKET;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return WelkinBlocks.FALSE_MILK_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    @Override
    public boolean matchesType(Fluid fluid) {
        return fluid == WelkinFluids.FALSE_MILK_STATIC || fluid == WelkinFluids.FALSE_MILK_FLOWING;
    }
    @Override
    ...
    public boolean canBeReplacedWith(FluidState state, BlockView world, BlockPos pos, Fluid fluid, Direction direction) {
        return direction == Direction.DOWN && !fluid.isIn(WelkinTags.FALSE_MILK);
    }
