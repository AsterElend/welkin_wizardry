...
import aster.welkin.block.entity.PedestalBlockEntity;
...
public class PedestalBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            if (world.getBlockEntity(pos) instanceof PedestalBlockEntity pylonBlockEntity) {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (!(blockEntity instanceof PedestalBlockEntity pylonBlockEntity)) {
            return result;
        }
    ...
    private ActionResult addItemFromHand(World world, PedestalBlockEntity pylonBlockEntity, PlayerEntity player, Hand hand) {
    ...
    private void removeItemFromTable(World world, PedestalBlockEntity pylonBlockEntity, PlayerEntity player) {
