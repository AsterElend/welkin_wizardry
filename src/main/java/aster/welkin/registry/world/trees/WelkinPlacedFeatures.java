...
public class WelkinPlacedFeatures {
    ...
    public static void bootstrap(Registerable<PlacedFeature> context) {
      ...
      //  register(context, FRACTAL_TREE_PLACED, configuredFeatureRegistryLookup.getOrThrow(WelkinConfiguredFeatures.FRACTAL_TREE_KEY),
          //     morestuff);
